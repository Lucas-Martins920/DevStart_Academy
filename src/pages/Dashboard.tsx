    ...
    <div className="min-h-screen bg-surface-0">
      ...
      <header className="border-b border-border">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-syne font-extrabold text-xl text-text-high tracking-tight">
              DEVSTART
            </span>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        >
          ...
          <h1 className="font-syne font-extrabold text-4xl text-text-high mt-2 mb-2 tracking-tight">
            APRENDA SCRATCH
          </h1>
        ...
        <motion.div
          ...
          className="bg-surface-1 rounded-3xl p-6 mb-10 border border-border"
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-text-mid uppercase tracking-wider">
              PROGRESSO GERAL
            </span>
